...
- "The whole problem with the world is that fools and fanatics are always so certain of themselves, but wiser peopel are so full of doubts"
- "The downfall didn't begin when Hitler marched into the Soviet Union. It didn't begin when the Japanese attacked Pearl Harbor, or on D-Day. The downfall began when Germany started putting their faith in a single man. When they elevated him to a roll he only ever used to persue his own personal glory."
#+end_quote
